...
if(isset($_POST['save'])){
  ...
  $dateCreated = date("Y-m-d");
    ...
    $query=mysqli_query($conn,"select * from tblteachers where emailAddress ='$emailAddress'");
    ...
    $query=mysqli_query($conn,"INSERT into tblteachers(firstName,lastName,emailAddress,password,phoneNo,classId,classArmId,dateCreated) 
...
//--------------------EDIT------------------------------------------------------------
 ...
 if (isset($_GET['Id']) && isset($_GET['action']) && $_GET['action'] == "edit")
    ...
    $query=mysqli_query($conn,"update tblteachers set firstName='$firstName', lastName='$lastName',
       ...
       <?php include "Includes/topbar.php";?>
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Create Facultys</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">Create Facultys</li>
            </ol>
          </div>
            ...
            <div class="col-lg-12">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Create Facultys</h6>
                    <?php echo $statusMsg; ?>
                </div>
                <div class="card-body">
                  <form method="post">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">All Facultys</h6>
                </div>
                <div class="table-responsive p-3">
                  ...
                  <?php
                      $query = "SELECT tblteachers.Id,tblclass.className,tblclassarms.classArmName,tblclassarms.Id AS classArmId,tblteachers.firstName,
                      tblteachers.lastName,tblteachers.emailAddress,tblteachers.phoneNo,tblteachers.dateCreated
                      FROM tblteachers
                      INNER JOIN tblclass ON tblclass.Id = tblteachers.classId
                      INNER JOIN tblclassarms ON tblclassarms.Id = tblteachers.classArmId";
                      $rs = $conn->query($query);
                      $num = $rs->num_rows;
                      $sn=0;
                      $status="";
